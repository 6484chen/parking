...
<script type="text/javascript">
	function exitSys() {
		...
		if (flag) {
			...
			window.top.close();
			//window.location.href = "${pageContext.request.contextPath}/admin/login/login.jsp";
		}
...
<body>
	<div class="height1">
		<div flaot="left" class="div-inline" style="width:70px,height:70px"><img src="${pageContext.request.contextPath}/images/loge.jpg" width="70px" height="70px"></div>
		<div flaot="left" class="div-inline"><img class="img_logo" src="${pageContext.request.contextPath}/images/parkTitle.png"  ></div>
	</div>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="155" valign="bottom" background="${pageContext.request.contextPath}/images/mis_05b.jpg">
										<font color="blue"> <a href="${pageContext.request.contextPath}/exit" target="_top">退出系统</a></font></td>
